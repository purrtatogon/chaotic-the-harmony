...
/** JSON for one CMS block (id, section, key, title, content). */
public class SiteContentBlockResponse {
    ...
    public SiteContentBlockResponse(String section, String key, String title, String content) {
        this(null, section, key, title, content);
    }

    public SiteContentBlockResponse(Long id, String section, String key, String title, String content) {
        this.id = id;
