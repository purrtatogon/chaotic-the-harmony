...
/** Request body for create/update product from the admin UI (images can be URL list or rich objects). */
public class ProductDTO {
    ...
    private List<Map<String, Object>> images; // Preferred: url + alt per row for the gallery editor.
    ...
    public void setProductType(Object productType) {
        if (productType == null) {
            ...
            // Parse enum from JSON string payloads
