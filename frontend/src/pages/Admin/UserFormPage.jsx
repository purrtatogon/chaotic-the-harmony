...
const UserFormPage = () => {
  ...
  if (loading) return <AdminLoading styles={styles} message="Loading user..." />;
  if (forbidden) {
      ...
      <PageHeader
        ...
        actions={
          <div className={styles.pageHeaderActions}>
            <Link className={styles.actionLink} to={`/admin/users/${id}`}>← Back to profile</Link>
            <Link className={styles.actionLink} to="/admin/users">← Back to Users</Link>
          </div>
        }
      />
