        ...
        >
          ...
          <div className={styles.authField}>
            ...
            <p id="password-hint" className={styles.authHint}>
              Passwords require at least {PASSWORD_MIN_LENGTH} characters with mixed case, numbers, and special characters.
            </p>
            <input
              id="password"
              type="password"
              ...
              required
              aria-describedby={passwordMissing ? 'password-error password-hint' : 'password-hint'}
